...
export const ArrowRight = (sx: any) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className={"lucide lucide-arrow-right-icon lucide-arrow-right" + sx}
    >
      <path d="M5 12h14" />
...
export const Logo = () => {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <polyline stroke="#f59e0b" points="6,6 1,12 6,18"></polyline>

      <ellipse cx="12" cy="8" rx="3.5" ry="1.2"></ellipse>
      <path d="M8.5 8v6a3.5 1.2 0 0 0 7 0V8"></path>
      <path d="M8.5 11a3.5 1.2 0 0 0 7 0"></path>

      <polyline stroke="#f59e0b" points="18,6 23,12 18,18"></polyline>
    </svg>
  );
};
...
export const Grid = () => {
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className="lucide lucide-grid3x3-icon lucide-grid-3x3"
    >
...
export const Browser = () => {
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className="lucide lucide-chromium-icon lucide-chromium"
    >
